  ...
  <div class="panel panel-default">
         ...
         <div class="panel-body  ">
             ...
             foreach($profil as $baris){
                 ?>
               <form name="coba" action="<?php echo base_url('admin/update_profil');?>" method="post" enctype="multipart/form-data">
                         ...
                         <fieldset>
                          ...
                          <div class="col-lg-3">
                              <div class="form-group">
                                  <label>ID User</label>
                                  <input class="form-control" size="1" name="id" type="text" value="<?php echo $baris->id_admin; ?>" readonly>
                              </div>
                              <div class="form-group">
                          ...
                          <div class="col-lg-3">
                              ...
                              <div class="form-group">
                                  ...
                                  <input class="form-control" name="no_rek" type="text" value="<?php echo $baris->no_rekening; ?>" >
                              </div>
                             </div>
                          <div class="col-lg-3">
                          <div class="form-group">
